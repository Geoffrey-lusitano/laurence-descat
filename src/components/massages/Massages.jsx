      ...
      <div className="content massages__aromatouch">
        <div className="acc__content">
          ...
          <p>
            ...
            est effectuée sur la colonne vertébrale et les pieds en même temps
            que des gestes de massages, aide à favoriser un état d’équilibre et
            un fonctionnement normal du corps. Un entretien préalable permet de
            connaître les éventuelles contre-indications à l’usage d’huiles
            essentielles et dans ce cas le massage est adapté.
          </p>
        </div>
